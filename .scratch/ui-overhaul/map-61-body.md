...
- [Task: Real code editor for SQL and common languages](https://github.com/xamdxlonewolf/apex_pilot/issues/70) — Shared Monaco (`@monaco-editor/react`, local Vite workers) for SQL Editor + File Editor; language map in `editorLanguages.ts`; protected APEX/`f*.sql` read-only. PR: https://github.com/xamdxlonewolf/apex_pilot/pull/80. Asset: `.scratch/ui-overhaul/code-editor-library-choice.md`
