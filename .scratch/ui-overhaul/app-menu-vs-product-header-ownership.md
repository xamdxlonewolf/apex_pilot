...
| **App Menu → Help** | About; docs / repo link; **Command Palette…** (Ctrl+Shift+P; not a shortcuts cheatsheet); **Check for updates…**; **Compare project to database…** (Stub entry on-map; live compare later) |
