...
- UX review polish P2 status-bar truncate / P3 Files actionable empty line — ticket only if still fog after open Tasks (B1 #102, H1+M4 #104, H2 #106, Mission empty-state #97, CTA/schema #96).
## Out of scope
